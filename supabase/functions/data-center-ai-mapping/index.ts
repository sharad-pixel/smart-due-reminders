...
const FIELD_DEFINITIONS = {
  ...
  invoice: [
    ...
    { key: "amount_outstanding", label: "Outstanding Amount", aliases: ["outstanding", "balance", "amount due", "remaining", "open amount", "outstanding amount", "balance due", "amount outstanding"] },
    ...
    { key: "payment_terms", label: "Payment Terms", aliases: ["payment terms", "terms", "net terms", "net 30", "net 60"] },
    { key: "paid_date", label: "Paid Date", aliases: ["paid date", "payment date", "date paid", "settled date"] },
    { key: "external_invoice_id", label: "External Invoice ID", aliases: ["external id", "system id", "reference"] },
    { key: "recouply_account_id", label: "Recouply Account ID (RAID)", aliases: ["raid", "recouply id", "recouply account id", "account raid", "customer raid", "account raid"] },
  ],
  payment: [
