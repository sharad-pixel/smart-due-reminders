      ...
      if (!finalDebtorId && resolvedNewDebtor && resolvedNewDebtor.company_name) {
        ...
        if (finalDebtorId && matchVia === "name_dedupe") {
          ...
          const { data: created, error: cErr } = await supabase.from("debtors").insert({
            ...
            billing_address_line1: resolvedNewDebtor.billing_address_line1 || resolvedNewDebtor.address || null,
            billing_address_line2: resolvedNewDebtor.billing_address_line2 || null,
            billing_city: resolvedNewDebtor.billing_city || null,
            billing_state: resolvedNewDebtor.billing_state || null,
            billing_postal_code: resolvedNewDebtor.billing_postal_code || null,
            billing_country: resolvedNewDebtor.billing_country || null,
            city: resolvedNewDebtor.billing_city || null,
            postal_code: resolvedNewDebtor.billing_postal_code || null,
            country: resolvedNewDebtor.billing_country || null,
            payment_terms_default: resolvedNewDebtor.payment_terms || null,
            notes: resolvedNewDebtor.notes || null,
            reference_id: refId,
