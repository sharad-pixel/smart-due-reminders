    ...
    try {
      ...
      if (isExistingUser && !inviteToken) {
        ...
        newUserBodyContent = `
          ...
          <p style="margin: 0 0 20px; color: #475569; font-size: 14px; line-height: 1.7;">
            <strong>${reassignedByName}</strong> has invited you to join <strong>${accountOwnerName}'s</strong> team on Recouply.ai${isExistingUser ? '.' : ', the Revenue Intelligence Platform.'}
          </p>
