...
import { getPersonaToneByDaysPastDue, getPersonaToneByBucket, toneIntensityModifiers } from '../_shared/personaTones.ts';
...
function getDefaultTemplate(bucket: string): string {
  const templates: Record<string, string> = {
    ...
    dpd_151_plus: 'Generate a final internal collections message. Be authoritative and firm, demanding immediate resolution. Do not threaten legal action or third-party collections.',
  };
