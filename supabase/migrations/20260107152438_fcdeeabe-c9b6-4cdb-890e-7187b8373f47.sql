-- Harden invoice_status enum handling: accept legacy lowercase 'paid' but normalize to canonical 'Paid'
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1
...
AS $$
BEGIN
  -- Normalize legacy labels that may still be sent by older clients/functions
