        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Why AI-Powered Collections Cost Less — and Scale More
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Replacing reactive, headcount-heavy collections with always-on AI agents.
            </p>
          </div>
              ...
              <CardContent className="pt-6">
                ...
                <div className="border-t pt-4">
                  ...
                  <p className="text-lg font-medium text-primary mb-4">
                    For less than the cost of a single full-time collections hire
                  </p>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y">
                  <tr>
                    ...
                    <td className="p-4 text-muted-foreground">Business hours</td>
                    <td className="p-4 text-primary font-medium">24/7 / 365</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-medium">Scale</td>
                    <td className="p-4 text-muted-foreground">Linear (hire more people)</td>
                    <td className="p-4 text-primary font-medium">Instant (software)</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-medium">Cost Model</td>
                    <td className="p-4 text-muted-foreground">Fixed + benefits</td>
                    <td className="p-4 text-primary font-medium">Transparent subscription</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-medium">Reaction Time</td>
                    <td className="p-4 text-muted-foreground">Often late</td>
                    <td className="p-4 text-primary font-medium">Proactive</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-medium">Visibility</td>
                    <td className="p-4 text-muted-foreground">Limited</td>
                    <td className="p-4 text-primary font-medium">Full real-time dashboards</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-xs">
              ...
              <a 
                href="https://www.indeed.com/career/accounts-receivable-analyst/salaries" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-primary hover:underline"
              >
          ...
          <div className="mt-12 text-center">
            <Button size="lg" onClick={() => handlePlanClick("growth")}>
              See How Recouply Compares to Your Current Cost
            </Button>
          </div>
        </div>
      </section>
