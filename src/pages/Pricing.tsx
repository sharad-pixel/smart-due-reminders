...
import { PLAN_CONFIGS, SEAT_PRICING, ANNUAL_DISCOUNT_RATE, CREDIT_PRICING, LIVE_CONTRACTS_PRICING, INVOICE_PRICING, SMART_INGESTION_PRICING, formatPrice } from "@/lib/subscriptionConfig";
              ...
              <CardContent className="pt-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">AI Smart Ingestion — Google Drive PDF extraction available on all plans</p>
                  </div>
                ...
                <ul className="space-y-2 text-sm text-muted-foreground mb-4">
                  <li className="flex items-center gap-2">
                    ...
                    AI Smart Ingestion reads any PDF — digital, scanned paper invoices, or photos
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-primary shrink-0" />
