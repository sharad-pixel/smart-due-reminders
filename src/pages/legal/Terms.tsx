          ...
          <section id="subscriptions">
            ...
            <div className="space-y-6 pl-9">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li><strong>Order Form Terms:</strong> Order Forms will clearly define all payment terms, including billing frequency, amounts due, and payment due dates. The Order Form constitutes the binding agreement for payment obligations</li>
                  ...
                  <li><strong>Access Restriction:</strong> In the event payments are not received within thirty (30) days from the due date as specified in the Order Form, Customer's access to the platform will be restricted until all outstanding balances are paid in full</li>
