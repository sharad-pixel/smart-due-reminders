...
const PowerOfOutreach = () => {
  ...
  return (
    <BlogPostLayout post={post}>
      ...
      <p>
        Recouply.ai is a <strong>Revenue Intelligence Platform</strong> designed to automate outreach while giving teams full visibility into customer engagement and payment behavior.
      </p>
