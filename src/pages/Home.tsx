...
const Home = () => {
  const homeFaqs = [
    ...
    { question: "What is Collectability Assurance?", answer: "Every contract ingested by Recouply is scored for collectability using its terms, credit history, and real-time risk signals. Contract Intelligence extracts what was sold; Collection Intelligence ensures it gets collected — with alerts if any obligation drifts off-track." },
