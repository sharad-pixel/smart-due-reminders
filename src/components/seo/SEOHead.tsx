...
const SEOHead = ({
  ...
  useEffect(() => {
    ...
    updateMeta('og:image:alt', `${SITE_CONFIG.siteName} - Revenue Intelligence Platform`, true);
    ...
    updateMeta('twitter:image:alt', `${SITE_CONFIG.siteName} - Revenue Intelligence Platform`);
