...
import { Mail, Clock, Sparkles, Eye } from "lucide-react";
...
const WorkflowGraph = ({ steps, onGenerateContent, onPreviewMessage, isGenerating, stepInvoiceCounts, stepDraftCounts }: WorkflowGraphProps) => {
