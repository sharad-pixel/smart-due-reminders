...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes! Recouply.ai integrates with Stripe and QuickBooks for real-time invoice syncing. We also offer AI Smart Ingestion — connect your Google Drive folder and our AI reads any invoice PDF (digital exports, scanned paper invoices, or even phone photos) and extracts the data automatically. Additional integrations with NetSuite, Salesforce, and more are coming soon."
  },
];
