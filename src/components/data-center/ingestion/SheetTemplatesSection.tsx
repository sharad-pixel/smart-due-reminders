...
const TEMPLATE_TYPES = [
  ...
  { key: 'contracts', label: 'Contracts', icon: FileText, description: 'Full contract data: master, performance obligations, risk flags, key dates & links. Push refreshes AI-derived data; Pull syncs status, resolved flags, alerts & link edits back.' },
] as const;
