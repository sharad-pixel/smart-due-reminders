      ...
      <Card className="border-dashed border-2">
        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-sm text-muted-foreground max-w-md mb-6">
            Connect your Google Drive to automatically scan any invoice PDF — digital exports, scanned paper invoices, or even phone photos — extract data with AI Smart Ingestion, and import clean records into Recouply with full review control.
          </p>
          {isGoogleUser && (
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-6 text-xs text-muted-foreground">
            ...
            <span className="flex items-center gap-1"><Scan className="h-3 w-3" /> AI Smart Ingestion for scanned PDFs</span>
