...
export const COMPANY_INFO = {
  ...
  description: "Revenue Intelligence Platform for Finance Teams that analyzes every touchpoint—accounts, communications, payments, tasks, and notes—to maximize receivables recovery.",
