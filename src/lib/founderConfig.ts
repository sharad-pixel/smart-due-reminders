...
export const companyValues = [
  {
    title: "Accuracy Over Aesthetics",
    description: "Real finance-grade data quality."
  },
  {
    title: "Automation Over Headcount",
    description: "Agents do the heavy lifting."
  },
  {
    title: "Clarity Over Complexity",
    description: "Revenue teams deserve systems that make sense."
  },
  {
    title: "Speed Over Process Bloat",
    description: "Iterate fast, improve daily."
  },
  {
    title: "User Empowerment",
    description: "Give teams superpowers through AI."
  }
];

export const enterpriseFeatures = [
  "Accurate invoice ingestion",
  "AI-powered mapping and dedupe",
  "Payment matching intelligence",
